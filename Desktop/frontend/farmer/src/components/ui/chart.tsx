                    ...
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          ...
                          // FIXED: Convert inline style to Tailwind
                          style={{
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  // Try to get the key from payload
  if (key in typedPayload && typeof typedPayload[key] === "string") {
    configLabelKey = typedPayload[key] as string;
  } 
  // Try to get from payload.payload
  else if ("payload" in typedPayload && 
           typeof typedPayload.payload === "object" && 
           typedPayload.payload !== null &&
           key in typedPayload.payload &&
           typeof (typedPayload.payload as Record<string, unknown>)[key] === "string") {
    configLabelKey = (typedPayload.payload as Record<string, unknown>)[key] as string;
  }
